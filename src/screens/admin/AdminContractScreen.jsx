...
export default function AdminContractScreen({ navigation }) {
  ...
  const loadContract = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/admin/contract`, {
        headers: {
      ...
      if (!res.ok || !payload?.contract) {
        Alert.alert("Error", payload?.message || "Failed to load contract.");
        setContract(null);
        return;
      }
      ...
      Alert.alert("Error", "Network error while loading contract.");
    } finally {
      setLoading(false);
    }
  }, [logout]);
