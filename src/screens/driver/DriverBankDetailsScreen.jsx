...
export default function DriverBankDetailsScreen({ navigation }) {
  ...
  const loadBankDetails = useCallback(async ({ silent = false } = {}) => {
    ...
    try {
      ...
      const res = await fetch(`${API_URL}/driver/bank-account`, {
        headers: {
      ...
      {notFound || !bank ? (
        <View style={styles.emptyWrap}>
          ...
          <Text style={styles.emptyText}>
            Bank account details are not available yet for this driver.
          </Text>
        </View>
      ) : (
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            <View style={styles.cardTitleWrap}>
              ...
              <Text style={styles.cardSubTitle}>Driver bank account</Text>
            </View>
            <View
              style={[
